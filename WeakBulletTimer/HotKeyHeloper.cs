// from https://sourcechord.hatenablog.com/entry/2017/02/13/005456
...
namespace WeakBulletTimer
{
    public class HotKeyItem
    {
        ...
        public HotKeyItem(Key key, EventHandler handler)
        {
            this.Key = key;
    ...
    public class HotKeyHelper : IDisposable
    {
        ...
        /// <returns></returns>
        public bool Register(Key key, EventHandler handler)
        {
            var modKeyNum = (int)0;
            ...
            while (this._hotkeyID < MAX_HOTKEY_ID)
            {
                ...
                {
                    // HotKeyのリストに追加
                    var hotkey = new HotKeyItem(key, handler);
